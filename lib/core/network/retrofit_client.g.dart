...
class _RetrofitClient implements RetrofitClient {
  ...
  @override
  Future<Movie> getMoviesList(Map<String, dynamic> query) async {
  ...
  @override
  Future<MovieDetails> getMovieDetails(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<Movie> search(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query);
    final _headers = <String, dynamic>{};
